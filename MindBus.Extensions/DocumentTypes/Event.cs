...
{
    [DocumentType(Name = "Event", IconUrl = "page.png", Thumbnail = "docWithImage.png", AllowedTemplates = new[] { "Event" }, DefaultTemplate = typeof(Event))]
    public class Event : PageSettings
    {
        ...
        [DocumentTypeProperty(UmbracoPropertyType.Other, OtherTypeName = "Agenda", Name = "Agenda", Tab = "Content", Description = "The time of the event")]
