namespace MindBus.Extensions.DocumentTypes
{
    ...
    [DocumentType(Name = "Site Settings", IconUrl = "sitemap_color.png", Thumbnail = "developer.png", AllowedChildNodeTypes = new[] { typeof(Overview), typeof(TextPage), typeof(Home), typeof(Events), typeof(NewsItems), typeof(Projects) })]
