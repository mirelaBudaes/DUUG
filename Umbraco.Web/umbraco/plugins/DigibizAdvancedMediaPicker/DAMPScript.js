...
function LoadDamp(clientId, hiddenFieldId, selectMulti, thumbHeight) {
...
function GetSelectDamp(clientId, hiddenFieldId, selectMulti, umbPath, nodeIds, thumbHeight, thumbWidth, cropPropertyAliasValue, cropNameValue, imageTypes, hideEdit, hideOpen, hidePixlr, updateSelect) {
...
function UpdateSelectDamp(clientId, hiddenFieldId, umbPath, nodeId, thumbHeight, thumbWidth, cropPropertyAliasValue, cropNameValue, imageTypes, hideEdit, hideOpen, hidePixlr, updateSelect) {
