...
<asp:Content ID="Content1" ContentPlaceHolderID="body" runat="server">
    ...
    <div>
        <asp:placeholder runat="server" ID="phSelectDestination" visible="false">
            ...
            <p>Please select where you wish to deploy this item to:</p> 
        ...
        <asp:placeholder runat="server" ID="phdefaultDestination" visible="false">
            <p>You are about to deploy this item to: <strong><asp:literal id="ltDestination" runat="server" /></strong></p>
        </asp:placeholder>
    </div>
        ...
        <div style="border-top: 1px solid #ccc">
            ...
            <!-- Only needed when the item has children -->
             ...
             <div id="specificChildSelection" style="display: none">
                ...
                <div id="loadingMsg">Connecting and deploying, please hold...</div>
          </div>
        </asp:placeholder>
    </umb:Pane>
